...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Write An Introduction Message",
    Description = "Function to write an introduction message.",
    `Authors@R` = c(person("Christine", "Hoogland", email = "christine.hoogland@finddx.org", role = c("aut", "cre")),
